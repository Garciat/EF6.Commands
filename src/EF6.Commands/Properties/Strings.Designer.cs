...
namespace EF6.Commands
{
    ...
    public static class Strings
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("EF6.Commands.Strings", typeof(Strings).GetTypeInfo().Assembly);
        ...
        /// </summary>
        public static string UnapplyMigration(object name)
        {
        ...
        /// </summary>
        public static string CannotFindAssembly(object assemblyName)
        {
